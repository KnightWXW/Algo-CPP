...
vector<int> Deadlock(vector<int> arr, vector<vector<int>> possess, vector<vector<int>> await);

int main()
{
    vector<int> arr_a1 = {100, 1, 2, 3, 0};
    vector<vector<int>> possess_a1 = {{}, {40, 20}, {10}, {100, 300}, {}};
