...
//          比方说，假设王国由国王，
//          他的孩子 Alice 和 Bob （Alice 比 Bob 年长）和 Alice 的孩子 Jack 组成。
//          一开始， curOrder 为 ["king"].
//          调用 Successor(king, curOrder) ，返回 Alice ，所以我们将 Alice 放入 curOrder 中，
//          得到 ["king", "Alice"] 。
//          调用 Successor(Alice, curOrder) ，返回 Jack ，所以我们将 Jack 放入 curOrder 中，
//          得到 ["king", "Alice", "Jack"] 。
//          调用 Successor(Jack, curOrder) ，返回 Bob ，所以我们将 Bob 放入 curOrder 中，
//          得到 ["king", "Alice", "Jack", "Bob"] 。
...
//              一个人的死亡不会影响 Successor 函数，也不会影响当前的继承顺序。
//              你可以只将这个人标记为死亡状态。
